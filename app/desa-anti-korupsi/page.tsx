...
export default function DesaAntiKorupsiPage() {
  ...
  const { antiKorupsiIndikatorList } = useData();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      {/* Pakta Integritas & Layanan Bebas Pungli */}
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        <div className="md:col-span-8 bg-slate-900 text-white p-6 sm:p-8 rounded-3xl shadow-lg space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Pernyataan Komitmen Bersama Pemerintahan Desa Banyuurip</p>
            </div>
          </div>

          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300">
            {info.paktaIntegritas.map((pakta, idx) => (
              <li key={idx} className="flex items-start gap-2 bg-slate-800/60 p-3.5 rounded-xl border border-slate-700/80">
        ...
        {/* Callout box */}
        <div className="md:col-span-4 bg-emerald-50 border border-emerald-200 p-6 sm:p-8 rounded-3xl space-y-3 text-xs text-emerald-950">
